...
def init_sgp4(
    ...
    """Initialise the SGP4 propagator with the given TLE elements.
    ...
    satrec.dM_coef = dM_coef
    satrec.raan_coef = raan_coef
...
def sgp4(satrec, tsince):
    ...
    delta_rfdot = (
        ...
        * n
        / pL
        * ((1 - satrec.theta**2) * cos2u - 3 / 2 * (1 - 3 * satrec.theta**2))
    )
